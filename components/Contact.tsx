        ...
        <div className="wrap">
          ...
          <div className="contact-grid">
            <div className="contact-info reveal">
              <div className="row"><div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-10 5L2 7" /></svg></div><div><div className="lbl">Email</div><div className="val">hello@vioniche.studio</div></div></div>
